...
- (void)customizeUserInterface {
    ...
    UITabBarItem *tabInbox = tabBarController.tabBar.items[0];
    UITabBarItem *tabFriends = tabBarController.tabBar.items[1];
    UITabBarItem *tabCamera = tabBarController.tabBar.items[2];
